...
public class TrollSlainController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        GameStateManager.setCurrentScenePath("/Scenes/Act1/Forest/Right/TrollSlain.fxml");
        caveButton.setFont(Font.font("Skia", 25));
        townButton.setFont(Font.font("Skia", 25));
